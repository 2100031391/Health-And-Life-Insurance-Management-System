  ...
  return (
    <div className="Services">
      ...
      >
        ...
        <Divider />
        <List>
          {[<Link to="/"  style={{color: "white"}}>Home</Link>, <li><Link to="/contact"  style={{color: "white"}}>Contact</Link></li>, <li><Link to="/start">health insurance policy</Link></li>,<li><Link to="/lifeinsurance" style={{color: "white"}}>life insurance policy</Link></li>].map((text, index) => (
        ...
        <Divider />
        <List>
          {[<Link to="/about"  style={{color: "white"}}>About</Link>, <li><Link to="/design"  style={{color: "white"}}>Agents</Link></li>, "FeedBack"].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon  style={{ color: "rgb(160, 255, 8)"}}>
