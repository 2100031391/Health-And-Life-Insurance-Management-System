  ...
  return (
    <div className="lifeplan">
      ...
      <Typography paragraph>
       ...
       <div className='mainu'>
        <h3 style={{color:"black", marginLeft: "900px", marginTop: "-350px"}}>Save <spam  style={{color:"red"}}>20%**</spam> on Life Insurance Premium</h3>
       ...
       <div>
       <button style={{height: "55px", width: "250px", backgroundColor:"Orange",  marginLeft: "900px", marginTop: "30px", borderRadius: "10px"}}><Link to="/lifepre" style={{color: "black", textDecoration:"none"}}>See Premium Plans 🡪</Link></button>
       </div>
