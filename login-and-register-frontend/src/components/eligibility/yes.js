  ...
  return (
    <div className="Start">
      ...
      <Typography paragraph>
       ...
       <div>
        <center>
        <h2 style={{color:"black"}}>You are <strong>NOT ELIGIBLE </strong>for this insurance plans</h2><br/><br/>
        <h2 style={{color:"black"}}>Click here to know required eligibilty for Life Insurance</h2><br/>
        <a href="/elirules"><button style={{color:"red", backgroundColor:"skyblue",height:"35px",width:"100px"}}><bold>Proceed</bold></button></a>
