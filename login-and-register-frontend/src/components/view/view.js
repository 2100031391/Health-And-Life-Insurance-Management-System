...
const rows = [
  ...
  //createData('EMD (in crores)', 5 ),
   createData('Opening Date', "05-12-2024" ),
   createData('Closing Date', "05-12-200242" ),
  ...
  return (
    <div className="View">
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
            <h3>Health and Life insurance system</h3>
          </Typography>
        </Toolbar>
      </AppBar>
      ...
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        <TableHead>
          <TableRow>
            <TableCell style={{color: "red"}}>Insurance Details</TableCell>
        ...
        <div className="login">
            ...
            <Link to="/pay"><Button variant="contained">pay</Button></Link>
