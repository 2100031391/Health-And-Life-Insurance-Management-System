  ...
  return (
    <div className="Start">
      ...
      <Typography paragraph>
       ...
       <div>
        <center>
        <h2 style={{color:"black"}}>Please Select the Required Policy</h2><br/><br/><br/>
        <button><a href='/plans'><h1>Health  Insurance</h1></a></button><br/><br/><br/>
        <button><a href='/lifepre'><h1>Life Insurance</h1></a></button>
        </center>
        </div>
        </Main>
    </Box>
